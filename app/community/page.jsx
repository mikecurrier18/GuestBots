        ...
        <div className="flex-col flex items-center justify-center text-center">
          <div className="max-w-[720px] lg:max-w-[800px] mb-6 md:mb-10 lg:mb-12">
            ...
            <div className="mx-auto max-w-[630px]">
              <p className="text-[#7c8aaa]">Lorem ipsum dolor sit amet consectetur adipiscing</p>
            </div>
          </div>
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <a href="#" className="flex-row flex max-w-full items-center justify-start gap-4 bg-[#07132d] px-8 py-5 font-bold text-[#7c8aaa] transition hover:text-white rounded-full">
            <Image 
